...
# MPC Simulator for Critical (Priority-weighted) Load Restoration Problem
    ...
    # with Co-optimization of Power and Reserve Products of DERs
"""
...
for i in range(num_time_steps):
    ...
    Ppv_cut, Pes, Qes, SOC_es, voltages, reserve_required, reserve_product, mu_P, mu_Q =\
...
print("Reserve Required:", required_reserve)
print("Reserve Provided:", provided_reserve)
